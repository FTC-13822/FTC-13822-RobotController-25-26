...
public class ForwardMove extends OpMode {
    ...
    static final double TICKS_PER_INCH = TICKS_PER_REV / (4 * 3.1415);
    ...
    public void encoderDrive(double speed, double distance, double timeout) {
        newBlmTarget = blm.getCurrentPosition() + (int) (distance * TICKS_PER_INCH);
        blm.setTargetPosition(newBlmTarget);
        newFrmTarget = frm.getCurrentPosition() + (int) (distance * TICKS_PER_INCH);
        frm.setTargetPosition(newBlmTarget);
        newFlmTarget = flm.getCurrentPosition() + (int) (distance * TICKS_PER_INCH);
        flm.setTargetPosition(newFlmTarget);
        newBrmTarget = brm.getCurrentPosition() + (int) (distance * TICKS_PER_INCH);
